...
function AddCoupon(props) {
    ...
    return (<ScrollView showsVerticalScrollIndicator={false}>
        ...
        color: '#696969',fontFamily: 'OpenSansBold',}}>Edit Coupon</Text>
            </View>
        ...
        fontFamily: 'OpenSansSemiBold'}}>Coupon Code Name</Text>
                ...
                <Text style={{fontSize:props.fontSize1,paddingTop: 1,color: '#696969',
        fontFamily: 'OpenSansSemiBold'}}>Coupon Code Description</Text>
                <TextInput style={styles.input1} />

                <Text style={{fontSize:props.fontSize1,paddingTop: 1,color: '#696969',
        fontFamily: 'OpenSansSemiBold'}}>Coupon Code Discount</Text>
                ...
                <Text style={{fontSize:props.fontSize1,paddingTop: 1,color: '#696969',
        fontFamily: 'OpenSansSemiBold'}}>Minimum Basket Value</Text>
                <TextInput style={styles.input1} />
                <View style={styles.side}>
                    <Text style={{fontSize:props.fontSize1,paddingTop: 1,color: '#696969',
        fontFamily: 'OpenSansSemiBold'}}>Coupon Bearer</Text>
                ...
                <View style={styles.side}>
                    <Text style={{fontSize:props.fontSize1,paddingTop: 1,color: '#696969',
        fontFamily: 'OpenSansSemiBold'}}>Commission</Text>
                    <TextInput style={styles.box}></TextInput>
                </View>
                <Text style={{fontSize:props.fontSize1,paddingTop: 1,color: '#696969',
        fontFamily: 'OpenSansSemiBold'}}>Total no. of Vouchers</Text>
                <TextInput style={styles.input1} />
                <Text style={{fontSize:props.fontSize1,paddingTop: 1,color: '#696969',
        fontFamily: 'OpenSansSemiBold'}}>No. of Redeems allowed for Users</Text>
                <TextInput style={styles.input1} />
                <Text style={{fontSize:props.fontSize1,paddingTop: 1,color: '#696969',
        fontFamily: 'OpenSansSemiBold'}}>Coupon Validity</Text>
                <TextInput style={styles.input1} />
                <Text style={{fontSize:props.fontSize1,paddingTop: 1,color: '#696969',
        fontFamily: 'OpenSansSemiBold'}}>Select Restaurant</Text>
            </View>
            <DropDownPicker style={styles.dropdown}
                items={[
                    { label: 'Admin', value: 'Admin' },
