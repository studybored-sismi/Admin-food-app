    ...
    return (
        ...
        <View style={styles.container}>
            <View style={styles.head}>
                <TouchableOpacity>
                    ...
                    onPress={() => props.navigation.navigate("Offer")} style={styles.menu} />
                </TouchableOpacity>
                <Text style={{fontSize:props.fontSize, paddingLeft: 50,paddingBottom: 5,
        color: '#696969',fontFamily: 'OpenSansBold',}}>Edit Banner</Text>
        ...
        paddingBottom: 2,color: '#696969'}}>Restaurant Branch</Text>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <Text style={{fontSize:props.fontSize1,fontFamily: 'OpenSansSemiBold',paddingTop: 10,
        paddingBottom: 2,color: '#696969'}}>Category</Text>
                </View>
