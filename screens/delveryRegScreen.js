    ...
    <View style={{ backgroundColor: '#f5fffa' }}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ flexDirection: 'row' }}>
          <Text style={{ marginLeft: 100, color: "#696969",  fontSize:props.fontSize1,
        ...
        <View style={styles.view3}>
          ...
          <View style={{ flexDirection: 'row', color: "red", marginLeft: 30 }}>
            ...
            <Text style={{ marginLeft: 10, marginTop: 10, fontFamily: "OpenSansRegular",
             color: "#696969", fontSize:props.fontSize1 }}>Choose Restaurant</Text>
          </View>


          <Text style={{ marginLeft: 35, fontFamily: "OpenSansRegular", color: "#696969", marginTop: 10, fontSize:props.fontSize1 }}>Name</Text>
          <TextInput style={styles.line} value={name} onChangeText={(text) => setName(text)} />

          <Text style={{ marginLeft: 35, fontFamily: "OpenSansRegular", color: "#696969" , fontSize:props.fontSize1}}>Email</Text>
          <TextInput style={styles.line} value={email} onChangeText={(text) => setEmail(text)} />

          <Text style={{ marginLeft: 35, fontFamily: "OpenSansRegular", color: "#696969", fontSize:props.fontSize1}}>Phone</Text>
          <TextInput style={styles.line} value={phone} onChangeText={(text) => setPhone(text)} keyboardType="number-pad" />

          <Text style={{ marginLeft: 35, fontFamily: "OpenSansRegular", color: "#696969",fontSize:props.fontSize1 }}>Occupation</Text>
          <TextInput style={styles.line} value={occupation} onChangeText={(text) => setOccupation(text)} />

          <Text style={{ marginLeft: 35, fontFamily: "OpenSansRegular", color: "#696969", marginBottom: 10,
         fontSize:props.fontSize1}}>Job Detail</Text>
          <DropDownPicker
            items={[
          ...
          <View style={{ flexDirection: 'row' }}>
            <Text style={{ marginLeft: 35, marginTop: 10, fontFamily: "OpenSansRegular", color: "#696969" , fontSize:props.fontSize1}}>ID</Text>
          ...
          <TouchableOpacity onPress={() => props.navigation.navigate("deliveryBoy")}>
            <Text style={{
              ...
              paddingRight: 40, fontFamily: 'OpenSansBold'
            }}>Save</Text>
          </TouchableOpacity>
        </View>
...
export default connect(mapStateToProps)(deliveryRegScreen);
